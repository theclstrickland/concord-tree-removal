  ...
  services: [
    {
      ...
      icon: '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2L7 10h3L6 18h12l-4-8h3L12 2z"/><rect x="11" y="18" width="2" height="4" rx="0.5" fill="currentColor" stroke="none"/></svg>',
    ...
    },
    {
      ...
      icon: '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><circle cx="6" cy="6" r="3"/><path d="M8.12 8.12L12 12"/><path d="M20 4L8.12 15.88"/><circle cx="6" cy="18" r="3"/><path d="M14.8 14.8L20 20"/></svg>',
    ...
    },
    {
      ...
      icon: '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><ellipse cx="12" cy="10" rx="8" ry="4"/><path d="M4 10v2c0 2.2 3.6 4 8 4s8-1.8 8-4v-2"/><circle cx="12" cy="10" r="2" opacity="0.5"/><circle cx="12" cy="10" r="5" opacity="0.3"/><line x1="12" y1="16" x2="12" y2="20"/><line x1="9" y1="16" x2="7" y2="21"/><line x1="15" y1="16" x2="17" y2="21"/></svg>',
      priceRange: '$100 – $500',
    ...
    },
    {
      ...
      icon: '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><circle cx="12" cy="16.5" r="0.5" fill="currentColor"/></svg>',
    ...
    },
    {
      ...
      icon: '<svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="6" width="20" height="12" rx="2"/><path d="M2 12h4l2-3 3 6 2-4 2 3h7"/><circle cx="18" cy="15" r="0.5" fill="currentColor"/></svg>',
